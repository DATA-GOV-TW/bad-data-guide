...
原始版本 : https://github.com/Quartz/bad-data-guide

**這份手冊盡可能列舉出在現實世界中，當我們在處理資料時會遇到的種種問題，並試著提出相對應的解決方法。**
...
* [中文 - DJ China 數據新聞](http://djchina.org/2016/07/12/bad_data_guide/) (完整)
* [中文 - 全球深度報導網](http://cn.gijn.org/2016/01/10/quartz%E5%9D%8F%E6%95%B0%E6%8D%AE%E6%8C%87%E5%8D%97%E7%B2%BE%E9%80%89%EF%BC%9A%E5%A4%84%E7%90%86%E6%95%B0%E6%8D%AE%E7%9A%84%E6%AD%A3%E7%A1%AE%E6%96%B9%E5%BC%8F%E4%B8%80%E8%A7%88/) (部分)
...
* [資料內容缺失](#values-are-missing)
* [缺失資料內容以零代替](#zeros-replace-missing-values)
...
* [文字拼寫不一致](#spelling-is-inconsistent)
* [Name order is inconsistent](#name-order-is-inconsistent)
* [日期格式不一致](#date-formats-are-inconsistent)
* [使用單位未標註](#units-are-not-specified)
...
* [出現可疑的數據內容](#suspicious-values-are-present)
* [Data are too coarse](#data-are-too-coarse)
* [Totals differ from published aggregates](#totals-differ-from-published-aggregates)
* [試算表有 65536 列 (row)](#spreadsheet-has-65536-rows)
* [試算表有 255 行 (column)](#spreadsheet-has-255-columns)
* [試算表內含日期為 1900, 1904, 1969 或 1970](#spreadsheet-has-dates-in-1900-1904-1969-or-1970)
* [文字內容被轉為數字](#text-has-been-converted-to-numbers)
* [數字內容以文字格式儲存](#numbers-have-been-stored-as-text)

## 資料使用者（你）該解決的問題

* [Text is garbled](#text-is-garbled)
* [Line endings are garbled](#line-endings-are-garbled)
* [資料在 PDF 檔案內](#data-are-in-a-pdf)
...
* [資料被手動修改過](#data-have-been-manually-edited)
...
### 試算表內含日期為 1900, 1904, 1969 或 1970
